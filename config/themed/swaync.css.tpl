/* SwayNC stylesheet restored from the user's pre-omarchy waybar-era config
   (commit a96aa85): the swaync stock layout with the fixed greys replaced by
   theme tokens. omarchy-theme-set-templates resolves {{ ... }} from the
   active theme's colors.toml on every omarchy-theme-set. */

@define-color cc-bg rgba({{ darker_background_rgb }}, 0.7);
@define-color noti-border-color rgba({{ foreground_rgb }}, 0.15);
@define-color noti-bg rgba({{ background_rgb }}, 0.8);
@define-color noti-bg-opaque {{ background }};
@define-color noti-bg-darker {{ dark_background }};
@define-color noti-bg-hover {{ lighter_background }};
@define-color noti-bg-hover-opaque {{ lighter_background }};
@define-color noti-bg-focus rgba({{ selection_rgb }}, 0.6);
@define-color noti-close-bg rgba({{ foreground_rgb }}, 0.1);
@define-color noti-close-bg-hover rgba({{ foreground_rgb }}, 0.15);
@define-color text-color {{ foreground }};
@define-color text-color-disabled {{ dark_foreground }};
