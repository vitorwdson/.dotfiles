...
local nvidia = paths.config_home .. "/.local/scripts/omarchy/omarchy-hw-nvidia"
local nvidia_gsp = paths.config_home .. "/.local/scripts/omarchy/omarchy-hw-nvidia-gsp"
local nvidia_without_gsp = paths.config_home .. "/.local/scripts/omarchy/omarchy-hw-nvidia-without-gsp"
